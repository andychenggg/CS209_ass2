...
public class ClientApplication extends Application {
  ...
  private static final AtomicReference<LoginSignupResponse> loginSignupResponse =
      new AtomicReference<>(new LoginSignupResponse());
  ...
  public static void sentLoginSignup(Protocols protocols, String username, String password)
      throws IOException {
